...
def main(args):
  ...
  elif os.path.basename(os.path.dirname(in_filename)) == 'aparc_seq': 
    nroi = 84; label_file = '/home/yh464/rds/rds-rb643-ukbiobank2/Data_Users/yh464/params/brain_region_labels_aparc.txt'
  ...
  if skip:
    _logger.log('Phenotypes already generated, skipping')
    return
  ...
  _logger.log(f'finished global and regional phenotypes. time = {toc:.3f} seconds')
  ...
  toc = time.perf_counter()-tic
  _logger.log(f'finished asymmetry phenotypes. time = {toc:.3f} seconds')
